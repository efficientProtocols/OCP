 ...
 */
#define	OS_NAME			"Unix, FreeBSD"
#define	OS_TYPE_UNIX
#define	OS_VARIANT_BSD
#define	OS_VARIANT_FreeBSD
#define	OS_FACILITY_BSDSockets
#define	OS_FACILITY_BSDTimers
 ...
 * DOS, the primary directory path separator is '\', but many
