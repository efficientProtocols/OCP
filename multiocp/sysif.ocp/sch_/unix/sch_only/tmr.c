...
>*/
PUBLIC Void
TMR_init(Int nuOfTimers, Int clockPeriod)
{
    Int i;
    tmr_Info *tq;
...
>*/
PUBLIC TMR_Desc
TMR_create(LgInt time, Int (*func)())
{
    tmr_Info *newTimer;
    tmr_Info *tq;
    LgInt absTime;
