 ...
 * File:	CRC-16
 *
 * Description: Calculate CRC-16 of a file.
 *
 *
-*/
...
#ifdef RCS_VER	/*{*/
static char rcs[] = "$Id: crc16.c,v 1.5 1996/11/07 02:46:03 kamran Exp $";
#endif /*}*/
...
PUBLIC MdUns PF_crc16(Byte *buf, Int len, MdUns prevCrc);
 ...
 * Function:	PF_crc16
 *
 * Description: The algorithm comes from 
...
>*/
PUBLIC MdUns 
PF_crc16 (Byte *buf, Int len, MdUns prevCrc)
{
    MdUns crc, x;
    Int i;
