...
#ifdef RCS_VER	/*{*/
static char rcs[] = "$Id: getlgint.c,v 1.5 1996/11/07 02:46:04 kamran Exp $";
#endif /*}*/
...
>*/
PUBLIC Int
PF_getLgInt(char *sp, LgInt *pl, LgInt def, LgInt min, LgInt max)
                       /* pointer to the string in question */
                        /* pointer to a LONG where the result goes */
                        /* the default value */
