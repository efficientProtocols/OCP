...
#ifdef RCS_VER	/*{*/
static char rcs[] = "$Id: oldmain.c,v 1.1.1.1 1997/10/21 18:24:57 mohsen Exp $";
#endif /*}*/
...
main(int argc, char **argv)
{
	...
	case 'V':
	    ...
	    {
		if ( ! (copyrightNotice = RELID_getCopyrightNeda()) ) {
    ...
    fprintf(stdout, "------------------\n\n");
    fprintf(stdout, "%s\n", RELID_getCopyrightNeda());

    fprintf(stdout, "The AT&T copyright\n");
    fprintf(stdout, "------------------\n\n");
    fprintf(stdout, "%s\n", RELID_getCopyrightAtt());

    fprintf(stdout, "The Neda + AT&T copyright\n");
    fprintf(stdout, "-------------------------\n\n");
    fprintf(stdout, "%s\n", RELID_getCopyrightNedaAtt());
}
